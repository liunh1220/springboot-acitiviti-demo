...
public class DynamicDataSourceRegister implements ImportBeanDefinitionRegistrar, EnvironmentAware {
    ...
    private static final String DATASOURCE_TYPE_ACTIVITI= "com.zaxxer.hikari.HikariDataSource";
    //默认数据源
    private DataSource defaultDataSource;
    //用户自定义数据源
    private static Map<String, DataSource> slaveDataSources = new HashMap<>();
